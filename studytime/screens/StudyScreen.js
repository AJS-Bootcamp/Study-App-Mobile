...
import { View, Text, ScrollView, ActivityIndicator } from 'react-native'; // Import ActivityIndicator
...
const Study = () => {
  ...
  return (
    <View style={{ flex: 1, padding: 16 }}>
      <Text style={{ fontSize: 24, fontWeight: 'bold', marginBottom: 16 }}>Study Strategies</Text>
